...
my $t = Test::Mojo->new;
$t->get_ok('/paragraphs_lf')->status_is(200)->content_is("<p>a\012b\012c</p>");
$t->get_ok('/paragraphs_lf_lf')->status_is(200)->content_is("<p>a\012</p><p>b\012</p><p>c</p>");
$t->get_ok('/paragraphs_trailing_lf_lf')->status_is(200)->content_is("<p>a\012</p><p>b\012</p><p>c\012</p>");
$t->get_ok('/paragraphs_crlf')->status_is(200)->content_is("<p>a\015\012b\015\012c</p>");
$t->get_ok('/paragraphs_crlf_crlf')->status_is(200)->content_is("<p>a\015\012</p><p>b\015\012</p><p>c</p>");
